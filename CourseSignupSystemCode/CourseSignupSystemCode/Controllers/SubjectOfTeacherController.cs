...
namespace CourseSignupSystemCode.Controllers
{
    ...
    public class SubjectOfTeacherController : ControllerBase
    {
        ...
        public SubjectOfTeacherController(ISubjectOfTeacherService iSubjectService)
        {
        ...
        public async Task<IActionResult> AddNewSubject(SubjectOfTeacherDTO subjectDTO)
        {
        ...
        public async Task<IActionResult> UpdateSubject(int id, SubjectOfTeacherDTO subjectDTO)
        {
