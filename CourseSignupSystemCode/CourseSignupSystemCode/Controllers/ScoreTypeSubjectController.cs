...
namespace CourseSignupSystemCode.Controllers
{
    ...
    public class ScoreTypeSubjectController : ControllerBase
    {
        ...
        // Function GetAllSubjectsById (GET)
        [HttpGet("GetAllSubjectsById")]
        public async Task<IActionResult> GetAllSubjects()
        {
            var getAllSubjectsById = await _iScoreTypeSubjectService.GetAllSubjectsAsync();
            return Ok(getAllSubjectsById);
        }
